...
const defaultPortfolioData = {
  theme: {
    ...
    fontFamily: defaultSiteFontFamily,
  },
  profile: {
    greeting: "",
    name: "Mohaiminul Islam",
    headline:
      "Full-Stack Developer | MERN, React, Next.js, NestJS, Node.js, Express.js",
    summary:
      "I build production-ready web applications with React, TypeScript, Next.js, Node.js, Express.js, NestJS, MongoDB, and MySQL. Recent project work includes IpHint and Lose to Gain, covering REST APIs, payment integrations, reverse image search, AI-assisted nutrition-label analysis, automated email delivery, admin dashboards, and responsive user interfaces.",
    photo: "/mm.jpg",
    resumeLink:
  ...
  focusAreas: [
    {
      icon: "code",
      title: "React and Next.js interfaces",
      text: "Responsive product screens, dashboard flows, Redux-backed UI, and polished user-facing web experiences.",
    },
    {
      icon: "layers",
      title: "Node.js API work",
      text: "Express.js and NestJS REST APIs with payment, email, search, and AI service integrations.",
    },
    {
      icon: "briefcase",
      title: "Product delivery",
      text: "Admin workflows, production project ownership, deployment-minded implementation, and contest-tested problem solving.",
    },
  ],
  skillGroups: [
    {
    ...
    },
    {
      ...
      skills: [
        ...
        { title: "REST APIs", icon: "FaNetworkWired" },
    ...
    },
    {
      ...
      skills: [
        ...
        { title: "Microsoft SQL Server (MSSQL)", icon: "FaDatabase" },
      ],
    },
    {
      title: "Programming Languages",
      skills: [
        { title: "JavaScript (ES6+)", icon: "SiJavascript" },
    ...
    },
    {
      ...
      skills: [
        { title: "Paddle", icon: "SiPaddle" },
        { title: "SerpApi", icon: "FaMagnifyingGlass" },
        { title: "Gemini API", icon: "SiGooglegemini" },
        { title: "Email API", icon: "FaEnvelope" },
    ...
    },
    {
      ...
      skills: [
        { title: "python-docx", icon: "FaFileWord" },
        { title: "Excel", icon: "FaFileExcel" },
        { title: "Pandas", icon: "SiPandas" },
        { title: "NumPy", icon: "SiNumpy" },
        { title: "Matplotlib", icon: "FaChartLine" },
        { title: "Seaborn", icon: "FaChartPie" },
        { title: "Tableau", icon: "FaChartColumn" },
      ],
    },
  ],
  projects: [
...
export function normalizePortfolioData(data) {
  ...
  return {
    theme: {
      colors: normalizeSiteColors(theme.colors),
      fontFamily: cleanText(theme.fontFamily) || defaultSiteFontFamily,
    },
    profile: {
