...
const defaultPortfolioData = {
  ...
  experience: [
    {
      ...
      icon: "briefcase",
      details:
        "Developed and maintained React front-end features, built reusable component libraries, integrated third-party APIs, and collaborated with designers and backend engineers to deliver product increments on schedule.",
    },
    {
      ...
      icon: "briefcase",
      details:
        "Built client-facing full-stack features with MongoDB, Express.js, React, and Node.js; designed RESTful APIs; and strengthened code quality through reviews, validation, state management, and error handling.",
    },
    {
      title: "CS Graduate",
    ...
    },
    {
      ...
      icon: "briefcase",
      details: "Builds web application features across frontend, backend, and data layers.",
    },
    {
  ...
  contact: {
    formAction: "https://formspree.io/f/xzzppron",
  },
};
