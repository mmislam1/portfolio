...
const defaultPortfolioData = {
  profile: {
    ...
    headline: "Full-Stack Web Developer | MERN, Python Automation",
    summary:
      "Full-stack web developer with professional experience building scalable MERN applications, React interfaces, REST APIs, and admin workflows. Skilled across Next.js, React.js, Node.js, Express.js, Nest.js, MongoDB, PHP, and Python automation, with project work covering payment integrations, reverse image search, automated document generation, and user-facing dashboards. Strong algorithmic foundation through Codeforces, LeetCode, Google Kickstart, and Google Code Jam.",
    photo: "/mm.jpg",
    resumeLink:
