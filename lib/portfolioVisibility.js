...
export function hasContactContent(data = {}) {
  return (
    hasText(data.contact?.formAction) ||
    hasText(data.profile?.resumeLink) ||
    hasItems(getVisibleProfileLinks(data.profile?.links || []))
  );
}
